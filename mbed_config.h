...
#define BLE_BUTTON_PIN_NAME                                                   BUTTON1                                                                                          // set by application[NRF52840_DK]
#define BLE_BUTTON_PIN_PULL                                                   PullNone                                                                                         // set by application
#define BLE_FEATURE_EXTENDED_ADVERTISING                                      0                                                                                                // set by application[*]
#define BLE_FEATURE_GATT_CLIENT                                               0                                                                                                // set by application[*]
#define BLE_FEATURE_GATT_SERVER                                               1                                                                                                // set by library:ble
#define BLE_FEATURE_PERIODIC_ADVERTISING                                      0                                                                                                // set by application[*]
#define BLE_FEATURE_PHY_MANAGEMENT                                            0                                                                                                // set by application[*]
...
#define BLE_ROLE_CENTRAL                                                      0                                                                                                // set by application[*]
#define BLE_ROLE_OBSERVER                                                     1                                                                                                // set by application[*]
